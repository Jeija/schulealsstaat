...
echo "#########################"
echo "Master server installtion"
echo "#########################"
sleep 1.5

exec 3>&1
SERVERIP=$(dialog --nocancel --inputbox Server\ IP? 10 50 10.10.5.10 2>&1 1>&3)
...
echo "Master installation completed, you should reboot now to activate the database."
